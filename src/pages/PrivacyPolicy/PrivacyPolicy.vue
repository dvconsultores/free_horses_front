<template>
  <section id="privacyPolicy" class="divcol seccion" :style="`background-image: url('${$store.state.baseURL}themes/${$store.state.theme}/bg.png')`">
    ...
    <ul>
      <li v-for="(item, index) in dataDefinitions" :key="index">
        <strong>{{ item.title }}</strong> {{ item.list }}<a :href="item.link" target="_blank">{{ item.link }}</a>
      </li>
    </ul>
    ...
    <p>
      ...
      Your mobile device's unique ID, the IP address of Your mobile device, Your mobile operating system, 
    ...
    <ul>
      <li v-for="(item, index) in dataTracking" :key="index">
        {{ item.title}} {{ item.text }}<a :href="item.link" target="_blank">{{ item.link }}</a>
      </li>
    </ul>
    <p>
      Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal 
      computer or mobile device when You go offline, while Session Cookies are deleted as soon as 
      You close Your web browser. You can learn more about cookies here: Cookies by TermsFeed Generator.
    </p>
    <p>We use both Session and Persistent Cookies for the purposes set out below:</p>
    <ul>
      <li v-for="(item, index) in dataTracking2" :key="index">
    ...
    <ul>
      <li v-for="(item, index) in dataUse" :key="index">
        {{ item.title}} {{ item.text }}
      </li>
    </ul>
    <p>We may share Your personal information in the following situations:</p>
    <ul>
      <li v-for="(item, index) in dataUse2" :key="index">
        {{ item.title}} {{ item.text }}
      </li>
    </ul>
    ...
    <ul>
      <li v-for="(item, index) in dataLegal" :key="index">
        {{ item.text }}
      </li>
    </ul>
    ...
    <h1>Contact Us</h1>
    <p>If you have any questions about this Privacy Policy, You can find us:</p>
    <ul>
      <li v-for="(item, index) in dataContact" :key="index">
...
export default {
  name: "PrivacyPolicy",
  mounted() {
    this.$store.dispatch("ColorFooter", {key: 'color'})
  },
  data() {
    return {
      dataDefinitions: [
        {
          title: "Account",
          list: "means a unique account created for You to access our Service or parts of our Service."
        },
        {
          title: "Company",
          list: '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Paras Marketplace.'
        },
        {
          title: "Cookies",
          list: 'are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.'
        },
        {
          title: "Device",
          list: 'means any device that can access the Service such as a computer, a cell phone or a digital tablet.'
        },
        {
          title: "Personal Data",
          list: 'is any information that relates to an identified or identifiable individual. Service refers to the Website.'
        },
        {
          title: "Service Provider",
          list: 'means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, provide the Service on behalf of the Company, perform services related to the Service or assist the Company in analyzing how the Service is used.'
        },
        {
          title: "Usage Data",
          list: 'refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).'
        },
        {
          title: "Website",
          list: 'refers to Paras Marketplace, accessible from ',
          link: "https://paras.id/"
        },
        {
          title: "You",
          list: 'mean the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.'
        },
      ],
      dataTracking: [
        {
      ...
      dataTracking2: [
        {
          ...
          text: "Type: Session CookiesAdministered by: UsPurpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services."
        },
        {
          title: "Cookies Policy / Notice Acceptance Cookies",
          text: "Type: Persistent CookiesAdministered by: UsPurpose: These Cookies identify if users have accepted the use of cookies on the Website."
        },
        {
          title: "Functionality Cookies",
          text: "Type: Persistent CookiesAdministered by: UsPurpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website."
        },
      ],
      dataUse: [
        {
          title: "To provide and maintain our Service,",
          text: "including to monitoring the usage of our Service."
        },
        {
        ...
        },
        {
          ...
          text: "We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or another sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred."
        },
        {
      ...
      dataUse2: [
        {
          ...
          text: "We may share Your personal information with Service Providers to monitor and analyze the use of our Service, and to contact You."
        },
        {
          title: "For business transfers:",
      ...
      dataContact: [
        {
          text: "On Twitter: ",
          link: "https://twitter.com/ParasHQ"
        },
        {
          text: "On Instagram: ",
          link: "https://www.instagram.com/paras.hq/"
        },
        {
          text: "On Telegram: ",
          link: "https://t.me/parashq"
        },
        {
          text: "On Discord: ",
          link: "https://discord.com/invite/vWR2XBNupg"
        },
      ]
    }
  },
...
<style src="./PrivacyPolicy.scss" lang="scss" />
